...
首先，让我们从全局的角度去认识绘制优化：Android系统显示原理、性能分析工具、布局优化、避免过度绘制、合理的刷新机制、提升动画性能、卡顿监控方案的实现。


* [深入探索Android布局优化（一）]()（进行中~）

* [深入探索Android布局优化（二）]()（进行中~）

实战总结自：慕课网之Top团队大牛带你玩转Android性能分析与优化 第五章 App布局优化（进阶）、极客时间之Android开发高手课 UI优化（进阶）


* [深入探索Android卡顿优化（一）]()（进行中~）

* [深入探索Android卡顿优化（二）]()（进行中~）

实战总结自：慕课网之Top团队大牛带你玩转Android性能分析与优化 第六章 App卡顿优化（进阶）、极客时间之Android开发高手课 卡顿优化（进阶）、《Android移动性能实战》第四章 CPU（经验）、《Android移动性能实战》第七章 流畅度（经验）
